...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	if(isset($_POST["cat"]) && $_POST["cat"]!=0){
		...
		$sql = "SELECT * FROM products,categories WHERE product_cat = '$cat' AND product_cat=cat_id AND product_keywords LIKE '%$keyword%'" ;
		}
	}
	}else {
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@shopify.com">
